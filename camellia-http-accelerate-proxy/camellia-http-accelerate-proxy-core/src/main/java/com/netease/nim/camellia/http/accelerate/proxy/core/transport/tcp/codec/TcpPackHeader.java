 ...
 */
public class TcpPackHeader implements Marshallable {

    private TcpPackCmd cmd;
    private byte tag = 0;
    private long seqId;
    ...
    public void unmarshal(Unpack unpack) {
        this.cmd = TcpPackCmd.getByValue(unpack.popByte());
    ...
    public TcpPackCmd getCmd() {
        return cmd;
    }

    public void setCmd(TcpPackCmd cmd) {
        this.cmd = cmd;
    }
