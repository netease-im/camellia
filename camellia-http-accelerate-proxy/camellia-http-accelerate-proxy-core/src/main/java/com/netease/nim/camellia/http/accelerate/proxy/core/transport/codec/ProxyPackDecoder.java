 ...
 */
public class ProxyPackDecoder extends ByteToMessageDecoder {

    private static final Logger logger = LoggerFactory.getLogger(ProxyPackDecoder.class);

    public static String getName() {
        return "ProxyPackDecoder";
    }
