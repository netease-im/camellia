...
public interface ConfigHistoryDao {
    ...
    @Insert("insert into camellia_config_history (`type`, `namespace`, `config_id`, `old_config`, `new_config`, `operator_type`, `operator`,`create_time`)" +
    ...
    @Select("select `id`, `type`, `namespace`, `config_id` as configId, `old_config` as oldConfig, `new_config` as newConfig , `operator_type` as operatorType, `operator`,`create_time` as createTime from camellia_config_history " +
