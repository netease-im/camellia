 ...
 */
public class CamelliaMqIsolationControllerStatus {

    private static final Logger logger = LoggerFactory.getLogger(CamelliaMqIsolationControllerStatus.class);
    ...
    public static void setStatus(Status status) {
        CamelliaMqIsolationControllerStatus.status = status;
