 ...
 */
@Configuration
@EnableConfigurationProperties({CamelliaSnowflakeIdGenProperties.class})
public class CamelliaSnowflakeIdGenConfiguration {

    @Autowired(required = false)
    private CamelliaRedisTemplate camelliaRedisTemplate;

    @Bean
    public CamelliaSnowflakeIdGen camelliaSnowflakeIdGen(CamelliaSnowflakeIdGenProperties properties) {
        return new CamelliaSnowflakeIdGen(camelliaSnowflakeConfig(properties));
    }

    @Bean
    public CamelliaSnowflakeConfig camelliaSnowflakeConfig(CamelliaSnowflakeIdGenProperties properties) {
    ...
    public WorkerIdGen workerIdGen(CamelliaSnowflakeIdGenProperties properties) {
        ...
        CamelliaSnowflakeIdGenProperties.RedisWorkerIdGenConf conf = properties.getRedisWorkerIdGenConf();
