...
public class SetParamsUtils {
    ...
    public static SetParams setParams(String nxxx) {
    ...
    public static SetParams setParams(byte[] nxxx) {
        SetParams setParams = new SetParams();
        String nxxxStr = null;
        if (nxxx != null) {
            nxxxStr = SafeEncoder.encode(nxxx);
            if (nxxxStr.equalsIgnoreCase("nx")) {
                setParams.nx();
            } else if (nxxxStr.equalsIgnoreCase("xx")) {
                setParams.xx();
            }
        }
        return setParams;
