...
public class CamelliaRedisImpl implements ICamelliaRedis {
    ...
    @ReadOp
    @Override
    public List<String> zrange(@ShardingParam String key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrange(@ShardingParam String key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeWithScores(@ShardingParam String key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeWithScores(@ShardingParam String key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByScore(@ShardingParam String key, double min, double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByScore(@ShardingParam String key, String min, String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByScore(@ShardingParam String key, double max, double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByScore(@ShardingParam String key, double min, double max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByScore(@ShardingParam String key, String max, String min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByScore(@ShardingParam String key, String min, String max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByScore(@ShardingParam String key, double max, double min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam String key, double min, double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam String key, double max, double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam String key, double min, double max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByScore(@ShardingParam String key, String max, String min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam String key, String min, String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam String key, String max, String min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam String key, String min, String max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam String key, double max, double min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam String key, String max, String min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByLex(@ShardingParam String key, String min, String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrangeByLex(@ShardingParam String key, String min, String max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByLex(@ShardingParam String key, String max, String min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<String> zrevrangeByLex(@ShardingParam String key, String max, String min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrange(@ShardingParam byte[] key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrange(@ShardingParam byte[] key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeWithScores(@ShardingParam byte[] key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeWithScores(@ShardingParam byte[] key, long start, long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByScore(@ShardingParam byte[] key, double min, double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByScore(@ShardingParam byte[] key, byte[] min, byte[] max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByScore(@ShardingParam byte[] key, double max, double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByScore(@ShardingParam byte[] key, double min, double max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByScore(@ShardingParam byte[] key, byte[] max, byte[] min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByScore(@ShardingParam byte[] key, byte[] min, byte[] max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByScore(@ShardingParam byte[] key, double max, double min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam byte[] key, double min, double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam byte[] key, double max, double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam byte[] key, double min, double max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByScore(@ShardingParam byte[] key, byte[] max, byte[] min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam byte[] key, byte[] min, byte[] max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam byte[] key, byte[] max, byte[] min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrangeByScoreWithScores(@ShardingParam byte[] key, byte[] min, byte[] max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam byte[] key, double max, double min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<Tuple> zrevrangeByScoreWithScores(@ShardingParam byte[] key, byte[] max, byte[] min, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByLex(@ShardingParam byte[] key, byte[] min, byte[] max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrangeByLex(@ShardingParam byte[] key, byte[] min, byte[] max, int offset, int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByLex(@ShardingParam byte[] key, byte[] max, byte[] min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public List<byte[]> zrevrangeByLex(@ShardingParam byte[] key, byte[] max, byte[] min, int offset, int count) {
        LogUtil.debugLog(resource, key);
