...
public class CamelliaRedisPipelineImpl implements ICamelliaRedisPipeline0 {
    ...
    public CamelliaRedisPipelineImpl(Resource resource) {
        ...
        if (resource instanceof PipelineResource) {
            this.pipelineFactory = ((PipelineResource) resource).getPipelineFactory();
    ...
    private AbstractPipeline getPipeline(byte[] key) {
        return pipelineFactory.getPipeline(resource, JedisClusterCRC16.getSlot(key));
    }

    private AbstractPipeline getPipeline(String key) {
        return pipelineFactory.getPipeline(resource, JedisClusterCRC16.getSlot(key));
    }
    ...
    public Response<Long> append(@ShardingParam final byte[] key, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).append(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> decr(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).decr(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> set(@ShardingParam final String key, final String value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).set(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> get(@ShardingParam final String key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).get(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> decrBy(@ShardingParam final byte[] key, final long integer) {
        ...
        before(key, command);
        try {
            return getPipeline(key).decrBy(key, integer);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> del(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).del(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Boolean> exists(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).exists(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> expire(@ShardingParam final byte[] key, final int seconds) {
        ...
        before(key, command);
        try {
            return getPipeline(key).expire(key, seconds);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> pexpire(@ShardingParam final byte[] key, final long milliseconds) {
        ...
        before(key, command);
        try {
            return getPipeline(key).pexpire(key, milliseconds);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> expireAt(@ShardingParam final byte[] key, final long unixTime) {
        ...
        before(key, command);
        try {
            return getPipeline(key).expireAt(key, unixTime);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> pexpireAt(@ShardingParam final byte[] key, final long millisecondsTimestamp) {
        ...
        before(key, command);
        try {
            return getPipeline(key).pexpireAt(key, millisecondsTimestamp);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Boolean> getbit(@ShardingParam final byte[] key, final long offset) {
        ...
        before(key, command);
        try {
            return getPipeline(key).getbit(key, offset);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> getSet(@ShardingParam final byte[] key, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).getSet(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> getrange(@ShardingParam final byte[] key, final long startOffset, final long endOffset) {
        ...
        before(key, command);
        try {
            return getPipeline(key).getrange(key, startOffset, endOffset);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> hdel(@ShardingParam final byte[] key, final byte[]... field) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hdel(key, field);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Boolean> hexists(@ShardingParam final byte[] key, final byte[] field) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hexists(key, field);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> hget(@ShardingParam final byte[] key, final byte[] field) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hget(key, field);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Map<byte[], byte[]>> hgetAll(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hgetAll(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> hincrBy(@ShardingParam final byte[] key, final byte[] field, final long value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hincrBy(key, field, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> hincrByFloat(@ShardingParam final byte[] key, final byte[] field, final double value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hincrByFloat(key, field, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Set<byte[]>> hkeys(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hkeys(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> hlen(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hlen(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> hmget(@ShardingParam final byte[] key, final byte[]... fields) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hmget(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> hmset(@ShardingParam final byte[] key, final Map<byte[], byte[]> hash) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hmset(key, hash);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> hset(@ShardingParam final byte[] key, final byte[] field, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hset(key, field, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> hsetnx(@ShardingParam final byte[] key, final byte[] field, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hsetnx(key, field, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> hvals(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hvals(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> incr(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).incr(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> incrBy(@ShardingParam final byte[] key, final long integer) {
        ...
        before(key, command);
        try {
            return getPipeline(key).incrBy(key, integer);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> incrByFloat(@ShardingParam final byte[] key, final double value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).incrByFloat(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> lindex(@ShardingParam final byte[] key, final long index) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lindex(key, index);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> llen(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).llen(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> lpop(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lpop(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> linsert(@ShardingParam final String key, ListPosition where, String pivot, String value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).linsert(key, where, pivot, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> lpush(@ShardingParam final byte[] key, final byte[]... string) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lpush(key, string);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> lpushx(@ShardingParam final byte[] key, final byte[]... bytes) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lpushx(key, bytes);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> lrange(@ShardingParam final byte[] key, final long start, final long end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lrange(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> lrem(@ShardingParam final byte[] key, final long count, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lrem(key, count, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> lset(@ShardingParam final byte[] key, final long index, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lset(key, index, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> ltrim(@ShardingParam final byte[] key, final long start, final long end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).ltrim(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> persist(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).persist(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> rpop(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).rpop(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> rpush(@ShardingParam final byte[] key, final byte[]... string) {
        ...
        before(key, command);
        try {
            return getPipeline(key).rpush(key, string);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> rpushx(@ShardingParam final byte[] key, final byte[]... string) {
        ...
        before(key, command);
        try {
            return getPipeline(key).rpushx(key, string);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> sadd(@ShardingParam final byte[] key, final byte[]... member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).sadd(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> scard(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).scard(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> set(final byte[] key, final byte[] value, final byte[] nxxx, final byte[] expx, final long time) {
        ...
        before(key, command);
        try {
            SetParams setParams = SetParamsUtils.setParams(nxxx, expx, time);
            return getPipeline(key).set(key, value, setParams);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> setrange(@ShardingParam final byte[] key, final long offset, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).setrange(key, offset, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> setex(@ShardingParam final byte[] key, final int seconds, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).setex(key, seconds, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> psetex(@ShardingParam final byte[] key, final long milliseconds, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).psetex(key, milliseconds, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> setnx(@ShardingParam final byte[] key, final byte[] value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).setnx(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Set<byte[]>> smembers(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).smembers(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Boolean> sismember(@ShardingParam final byte[] key, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).sismember(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> sort(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).sort(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> sort(@ShardingParam final byte[] key, final SortingParams sortingParameters) {
        ...
        before(key, command);
        try {
            return getPipeline(key).sort(key, sortingParameters);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> spop(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).spop(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Set<byte[]>> spop(@ShardingParam final byte[] key, final long count) {
        ...
        before(key, command);
        try {
            return getPipeline(key).spop(key, count);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> srandmember(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).srandmember(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> srandmember(@ShardingParam final byte[] key, final int count) {
        ...
        before(key, command);
        try {
            return getPipeline(key).srandmember(key, count);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> srem(@ShardingParam final byte[] key, final byte[]... member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).srem(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> strlen(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).strlen(key);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<byte[]> substr(@ShardingParam final byte[] key, final int start, final int end) {
        LogUtil.debugLog(resource, key);
        String command = "substr(byte[] key, int start, int end)";
        before(key, command);
        try {
            return getPipeline(key).substr(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> ttl(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).ttl(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> pttl(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).pttl(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> type(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).type(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zadd(@ShardingParam final byte[] key, final double score, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zadd(key, score, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zadd(@ShardingParam final byte[] key, final double score, final byte[] member, final ZAddParams params) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zadd(key, score, member, params);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zcard(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zcard(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zcount(@ShardingParam final byte[] key, final double min, final double max) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zcount(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> zincrby(@ShardingParam final byte[] key, final double score, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zincrby(key, score, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> zincrby(@ShardingParam final byte[] key, final double score, final byte[] member, final ZIncrByParams params) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zincrby(key, score, member, params);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrange(@ShardingParam final byte[] key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
        String command = "zrange(byte[] key, long start, long end)";
        before(key, command);
        try {
            return getPipeline(key).zrange(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByScore(@ShardingParam final byte[] key, final double min, final double max) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByScore(byte[] key, double min, double max)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByScore(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByScore(@ShardingParam final byte[] key, final byte[] min, final byte[] max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByScore(@ShardingParam final byte[] key, final double min, final double max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByScore(byte[] key, double min, double max, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByScore(key, min, max, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByScore(@ShardingParam final byte[] key, final byte[] min, final byte[] max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final byte[] key, final double min, final double max) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByScoreWithScores(byte[] key, double min, double max)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByScoreWithScores(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final byte[] key, final byte[] min, final byte[] max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final byte[] key, final double min, final double max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByScoreWithScores(byte[] key, double min, double max, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByScoreWithScores(key, min, max, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final byte[] key, final byte[] min, final byte[] max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByScore(@ShardingParam final byte[] key, final double max, final double min) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByScore(byte[] key, double max, double min)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByScore(key, max, min);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByScore(@ShardingParam final byte[] key, final byte[] max, final byte[] min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByScore(@ShardingParam final byte[] key, final double max, final double min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByScore(byte[] key, double max, double min, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByScore(key, max, min, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByScore(@ShardingParam final byte[] key, final byte[] max, final byte[] min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final byte[] key, final double max, final double min) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByScoreWithScores(byte[] key, double max, double min)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByScoreWithScores(key, max, min);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final byte[] key, final byte[] max, final byte[] min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final byte[] key, final double max, final double min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByScoreWithScores(byte[] key, double max, double min, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByScoreWithScores(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final byte[] key, final byte[] max, final byte[] min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByScoreWithScores(byte[] key, byte[] max, byte[] min, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByScoreWithScores(key, max, min, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeWithScores(@ShardingParam final byte[] key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeWithScores(byte[] key, long start, long end)";
        before(key, command);
        try {
            return getPipeline(key).zrangeWithScores(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zrank(@ShardingParam final byte[] key, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zrank(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zrem(@ShardingParam final byte[] key, final byte[]... member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zrem(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zremrangeByRank(@ShardingParam final byte[] key, final long start, final long end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zremrangeByRank(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zremrangeByScore(@ShardingParam final byte[] key, final double start, final double end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zremrangeByScore(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrange(@ShardingParam final byte[] key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrange(byte[] key, long start, long end)";
        before(key, command);
        try {
            return getPipeline(key).zrevrange(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeWithScores(@ShardingParam final byte[] key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeWithScores(byte[] key, long start, long end)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeWithScores(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zrevrank(@ShardingParam final byte[] key, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zrevrank(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> zscore(@ShardingParam final byte[] key, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zscore(key, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<Double>> zmscore(@ShardingParam String key, String... members) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zmscore(key, members);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zlexcount(@ShardingParam final byte[] key, final byte[] min, final byte[] max) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zlexcount(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByLex(@ShardingParam final byte[] key, final byte[] min, final byte[] max) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByLex(byte[] key, byte[] min, byte[] max)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByLex(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrangeByLex(@ShardingParam final byte[] key, final byte[] min, final byte[] max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrangeByLex(byte[] key, byte[] min, byte[] max, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrangeByLex(key, min, max, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByLex(@ShardingParam final byte[] key, final byte[] max, final byte[] min) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByLex(byte[] key, byte[] max, byte[] min)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByLex(key, max, min);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<byte[]>> zrevrangeByLex(@ShardingParam final byte[] key, final byte[] max, final byte[] min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
        String command = "zrevrangeByLex(byte[] key, byte[] max, byte[] min, int offset, int count)";
        before(key, command);
        try {
            return getPipeline(key).zrevrangeByLex(key, max, min, offset, count);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zremrangeByLex(@ShardingParam final byte[] key, final byte[] min, final byte[] max) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zremrangeByLex(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> bitcount(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitcount(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> bitcount(@ShardingParam final byte[] key, final long start, final long end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitcount(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> pfadd(@ShardingParam final byte[] key, final byte[]... elements) {
        ...
        before(key, command);
        try {
            return getPipeline(key).pfadd(key, elements);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> pfcount(@ShardingParam final byte[] key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).pfcount(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> geoadd(@ShardingParam final byte[] key, final double longitude, final double latitude, final byte[] member) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geoadd(key, longitude, latitude, member);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> geoadd(@ShardingParam final byte[] key, final Map<byte[], GeoCoordinate> memberCoordinateMap) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geoadd(key, memberCoordinateMap);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> geodist(@ShardingParam final byte[] key, final byte[] member1, final byte[] member2) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geodist(key, member1, member2);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> geodist(@ShardingParam final byte[] key, final byte[] member1, final byte[] member2, final GeoUnit unit) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geodist(key, member1, member2, unit);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> geohash(@ShardingParam final byte[] key, final byte[]... members) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geohash(key, members);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<GeoCoordinate>> geopos(@ShardingParam final byte[] key, final byte[]... members) {
        ...
        before(key, command);
        try {
            return getPipeline(key).geopos(key, members);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<GeoRadiusResponse>> georadius(@ShardingParam final byte[] key, final double longitude, final double latitude, final double radius, final GeoUnit unit) {
        ...
        before(key, command);
        try {
            return getPipeline(key).georadius(key, longitude, latitude, radius, unit);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<GeoRadiusResponse>> georadius(@ShardingParam final byte[] key, final double longitude, final double latitude, final double radius, final GeoUnit unit, final GeoRadiusParam param) {
        ...
        before(key, command);
        try {
            return getPipeline(key).georadius(key, longitude, latitude, radius, unit, param);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<GeoRadiusResponse>> georadiusByMember(@ShardingParam final byte[] key, final byte[] member, final double radius, final GeoUnit unit) {
        ...
        before(key, command);
        try {
            return getPipeline(key).georadiusByMember(key, member, radius, unit);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<GeoRadiusResponse>> georadiusByMember(@ShardingParam final byte[] key, final byte[] member, final double radius, final GeoUnit unit, final GeoRadiusParam param) {
        ...
        before(key, command);
        try {
            return getPipeline(key).georadiusByMember(key, member, radius, unit, param);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<Long>> bitfield(@ShardingParam final byte[] key, final byte[]... elements) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitfield(key, elements);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> bitpos(@ShardingParam final byte[] key, final boolean value, final BitPosParams params) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitpos(key, value, params);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<String>> hmget(@ShardingParam final String key, final String... fields) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hmget(key, fields);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> lpushx(@ShardingParam final String key, final String... string) {
        ...
        before(key, command);
        try {
            return getPipeline(key).lpushx(key, string);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Boolean> setbit(@ShardingParam final String key, final long offset, final boolean value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).setbit(key, offset, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zadd(@ShardingParam final String key, final Map<String, Double> scoreMembers) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zadd(key, scoreMembers);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> zadd(@ShardingParam final String key, final Map<String, Double> scoreMembers, final ZAddParams params) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zadd(key, scoreMembers, params);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrange(@ShardingParam final String key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByScore(@ShardingParam final String key, final double min, final double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByScore(@ShardingParam final String key, final String min, final String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByScore(@ShardingParam final String key, final double min, final double max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final String key, final double min, final double max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final String key, final double min, final double max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByScore(@ShardingParam final String key, final double max, final double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByScore(@ShardingParam final String key, final String max, final String min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByScore(@ShardingParam final String key, final double max, final double min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final String key, final double max, final double min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final String key, final double max, final double min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeWithScores(@ShardingParam final String key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrange(@ShardingParam final String key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeWithScores(@ShardingParam final String key, final long start, final long end) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByLex(@ShardingParam final String key, final String min, final String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByLex(@ShardingParam final String key, final String min, final String max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByLex(@ShardingParam final String key, final String max, final String min) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByLex(@ShardingParam final String key, final String max, final String min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    public Response<Long> zremrangeByLex(@ShardingParam final String key, final String start, final String end) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zremrangeByLex(key, start, end);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<Long>> bitfield(@ShardingParam final String key, final String... arguments) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitfield(key, arguments);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<byte[]> dump(@ShardingParam final String key) {
        ...
        before(key, command);
        try {
            return getPipeline(key).dump(key);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<String> restore(@ShardingParam final byte[] key, final int ttl, final byte[] serializedValue) {
        ...
        before(key, command);
        try {
            return getPipeline(key).restore(key, ttl, serializedValue);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> hincrByFloat(@ShardingParam final String key, final String field, final double increment) {
        ...
        before(key, command);
        try {
            return getPipeline(key).hincrByFloat(key, field, increment);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Double> incrByFloat(@ShardingParam final String key, final double increment) {
        ...
        before(key, command);
        try {
            return getPipeline(key).incrByFloat(key, increment);
        } finally {
            after(key, command);
        }
    }
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrangeByScore(@ShardingParam final String key, final String min, final String max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final String key, final String min, final String max, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrangeByScoreWithScores(@ShardingParam final String key, final String min, final String max) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<String>> zrevrangeByScore(@ShardingParam final String key, final String max, final String min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final String key, final String max, final String min, final int offset, final int count) {
        LogUtil.debugLog(resource, key);
    ...
    @ReadOp
    @Override
    public Response<List<Tuple>> zrevrangeByScoreWithScores(@ShardingParam final String key, final String max, final String min) {
        LogUtil.debugLog(resource, key);
    ...
    public Response<Long> zremrangeByScore(@ShardingParam final String key, final String min, final String max) {
        ...
        before(key, command);
        try {
            return getPipeline(key).zremrangeByScore(key, min, max);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<Long> bitpos(@ShardingParam final String key, final boolean value) {
        ...
        before(key, command);
        try {
            return getPipeline(key).bitpos(key, value);
        } finally {
            after(key, command);
        }
    }
    ...
    public Response<List<byte[]>> mget0(@ShardingParam byte[] shardingKey, byte[]... keys) {
        ...
        try {
            return getPipeline(shardingKey).mget(keys);
        } finally {
