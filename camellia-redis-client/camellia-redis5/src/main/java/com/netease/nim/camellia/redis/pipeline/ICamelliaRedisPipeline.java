...
public interface ICamelliaRedisPipeline extends Closeable {
    ...
    Response<List<byte[]>> zrange(byte[] key, long start, long end);
    ...
    Response<List<Tuple>> zrangeByScoreWithScores(byte[] key, double min, double max, int offset,
                                                 int count);

    Response<List<Tuple>> zrangeByScoreWithScores(byte[] key, byte[] min, byte[] max, int offset,
                                                 int count);
    ...
    Response<List<Tuple>> zrevrangeByScoreWithScores(byte[] key, double max, double min, int offset,
                                                    int count);

    Response<List<Tuple>> zrevrangeByScoreWithScores(byte[] key, byte[] max, byte[] min, int offset,
                                                    int count);
    ...
    Response<List<byte[]>> zrevrange(byte[] key, long start, long end);

    Response<List<Tuple>> zrevrangeWithScores(byte[] key, long start, long end);
    ...
    Response<List<byte[]>> zrangeByLex(final byte[] key, final byte[] min, final byte[] max);

    Response<List<byte[]>> zrangeByLex(final byte[] key, final byte[] min, final byte[] max,
                                      int offset, int count);

    Response<List<byte[]>> zrevrangeByLex(final byte[] key, final byte[] max, final byte[] min);
    ...
    Response<List<String>> zrange(String key, long start, long end);
    ...
    Response<List<Tuple>> zrangeByScoreWithScores(String key, double min, double max, int offset,
                                                 int count);
    ...
    Response<List<Tuple>> zrevrangeByScoreWithScores(String key, double max, double min, int offset,
                                                    int count);
    ...
    Response<List<String>> zrevrange(String key, long start, long end);

    Response<List<Tuple>> zrevrangeWithScores(String key, long start, long end);
    ...
    Response<List<String>> zrangeByLex(final String key, final String min, final String max);

    Response<List<String>> zrangeByLex(final String key, final String min, final String max,
                                      final int offset, final int count);

    Response<List<String>> zrevrangeByLex(final String key, final String max, final String min);
