...
public class CamelliaRedisTemplate implements ICamelliaRedisTemplate {
    ...
    public ICamelliaRedisPipeline pipelined() {
        ...
        final PipelineFactory pipelineFactory = new PipelineFactory.DefaultPipelineFactory(env);
        ...
        return new CamelliaRedisPipeline(pipelineProxy, pipelineFactory, pipelinePool, resourceSelector);
    }
