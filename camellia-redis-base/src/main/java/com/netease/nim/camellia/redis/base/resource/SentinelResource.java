 ...
 */
public class SentinelResource extends Resource {
    ...
    public SentinelResource(List<RedisSentinelResource.Node> nodes, String sentinelUserName, String sentinelPassword) {
        this.nodes = nodes;
        this.sentinelUserName = sentinelUserName;
        this.sentinelPassword = sentinelPassword;
        StringBuilder url = new StringBuilder();
        url.append(RedisType.Sentinel.getPrefix());
