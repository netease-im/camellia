...
download *.tar.gz（v1.2.30）：
```
wget https://github.com/netease-im/camellia/releases/download/1.2.30/camellia-redis-proxy-1.2.30.tar.gz
tar zxvf camellia-redis-proxy-1.2.30.tar.gz
cd camellia-redis-proxy-1.2.30/
```
