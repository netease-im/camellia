...
|:--------------------:|:------:|:----:|:------:|:-------------:|:--------:|:---------------------------------------------------------------------:|:-----------------------------:|:-------------------------------:|-----:|
| camellia-redis-proxy | 1.2.10 |  支持  |   支持   |      支持       |    支持    |      支持eval/evalsha/eval_ro/evalsha_ro和script load/exists/flush       |              支持               |               支持                |   支持 | 
|      twemproxy       | 0.5.0  | 不支持  |  不支持   |      不支持      |   不支持    |                                仅支持eval                                |              不支持              |               不支持               |  不支持 |
|       predixy        | 1.0.5  |  支持  |   支持   |      支持       |    支持    | 支持eval/evalsha和script load，不支持eval_ro/evalhash_ro和script exists/flush |              不支持              |               不支持               |   支持 |
