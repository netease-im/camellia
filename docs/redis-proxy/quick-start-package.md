...
下载最新版安装包并解压（v1.0.58）：
```
wget https://github.com/netease-im/camellia/releases/download/v1.0.58/camellia-redis-proxy-1.0.58.tar.gz
tar zxvf camellia-redis-proxy-1.0.58.tar.gz
cd camellia-redis-proxy-1.0.58/
```
