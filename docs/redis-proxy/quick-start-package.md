...
下载最新版安装包并解压（v1.0.47）：
```
wget https://github.com/netease-im/camellia/releases/download/v1.0.47/camellia-redis-proxy-1.0.47.tar.gz
tar zxvf camellia-redis-proxy-1.0.47.tar.gz
cd camellia-redis-proxy-1.0.47/
```
