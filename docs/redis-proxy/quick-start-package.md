...
下载最新版安装包并解压（v1.0.51）：
```
wget https://github.com/netease-im/camellia/releases/download/v1.0.51/camellia-redis-proxy-1.0.51.tar.gz
tar zxvf camellia-redis-proxy-1.0.51.tar.gz
cd camellia-redis-proxy-1.0.51/
```
