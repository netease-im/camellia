...
## performance test（v1.0.8 vs v1.0.9）

|machine|configuration|args
|:---:|:---:|:---:|
|camellia-redis-proxy-async|4C8G virtual machine |-Xms4096m -Xmx4096m -XX:+UseG1GC|
|redis server|Intel(R)Xeon(R)E5-2650v3@2.30GHz 40core physical machine|Hybrid deployment|
|pressure measuring machine|Intel(R)Xeon(R)E5-2650v3@2.30GHz 40core physical machine||

## route to standalone redis

### scene_01（single-command）
```
...
## route to redis cluster(3_master/3_slave)
  
### scene_01（single_command）
```
./redis-benchmark -n 2000000 -r 10000 -c 200 -t set,get,incr,lpush,rpush,lpop,rpop,sadd,hset,spop,lpush,lrange -q -p 6380 -h 10.177.0.35
...
## route to redis cluster(15_master/15_slave)
