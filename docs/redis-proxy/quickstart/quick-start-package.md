...
下载最新版安装包并解压（v1.1.9）：
```
wget https://github.com/netease-im/camellia/releases/download/1.1.9/camellia-redis-proxy-1.1.9.tar.gz
tar zxvf camellia-redis-proxy-1.1.9.tar.gz
cd camellia-redis-proxy-1.1.9/
```
