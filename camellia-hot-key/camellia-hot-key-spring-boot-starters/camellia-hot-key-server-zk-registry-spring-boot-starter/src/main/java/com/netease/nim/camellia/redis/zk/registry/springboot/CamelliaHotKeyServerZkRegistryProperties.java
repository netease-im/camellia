...
import com.netease.nim.camellia.hot.key.extensions.discovery.zk.ZkHotKeyConstants;
 ...
 */
@ConfigurationProperties(prefix = "camellia-hot-key-zk-registry")
public class CamelliaHotKeyServerZkRegistryProperties {
     ...
     * 注册到zk时的根路径
     */
    private String basePath = ZkHotKeyConstants.basePath;
     ...
     */
    private boolean preferredHostName = ZkHotKeyConstants.preferredHostName;
