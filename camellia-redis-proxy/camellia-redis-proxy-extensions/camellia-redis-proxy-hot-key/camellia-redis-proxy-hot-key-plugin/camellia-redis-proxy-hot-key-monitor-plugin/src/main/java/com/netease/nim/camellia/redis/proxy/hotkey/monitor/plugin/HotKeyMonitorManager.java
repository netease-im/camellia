 ...
 */
public class HotKeyMonitorManager {
    /**
    ...
    public HotKeyMonitorManager(HotKeyMonitorConfig hotKeyMonitorConfig) {
     ...
     * DCL
     */
    public HotKeyMonitor getHotKeyMonitor(Long bid, String bgroup) {
