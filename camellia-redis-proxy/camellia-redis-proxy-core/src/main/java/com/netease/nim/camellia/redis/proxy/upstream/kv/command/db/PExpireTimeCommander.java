 ...
 */
public class PExpireTimeCommander extends Commander {

    public PExpireTimeCommander(CommanderConfig commanderConfig) {
        super(commanderConfig);
    }

    @Override
    public RedisCommand redisCommand() {
        return RedisCommand.PEXPIRETIME;
    }
    ...
    protected Reply execute(int slot, Command command) {
        ...
        return new IntegerReply(expireTime);
    }
}
