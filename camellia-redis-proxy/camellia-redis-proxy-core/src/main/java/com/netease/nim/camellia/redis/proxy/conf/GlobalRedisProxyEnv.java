...
import com.netease.nim.camellia.redis.proxy.netty.DefaultProxyShutdown;
...
public class GlobalRedisProxyEnv {
    ...
    private static CamelliaDiscoveryFactory discoveryFactory;
    ...
    public static CamelliaDiscoveryFactory getDiscoveryFactory() {
        return discoveryFactory;
    }

    public static void setDiscoveryFactory(CamelliaDiscoveryFactory discoveryFactory) {
