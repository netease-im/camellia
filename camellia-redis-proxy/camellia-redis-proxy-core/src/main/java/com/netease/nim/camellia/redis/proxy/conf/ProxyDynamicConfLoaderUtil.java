...
public class ProxyDynamicConfLoaderUtil {
    ...
    public static Pair<String, Map<String, String>> tryLoadDynamicConfBySpecificFilePath(Map<String, String> configMap, ConfigContentType contentType) {
        ...
        if (filePath != null) {
            ...
            if (info != null && info.getFileContent() != null) {
                Map<String, String> map = ConfigurationUtil.contentToMap(info.getFileContent(), contentType);
                conf.putAll(map);
