...
public interface BigKeyMonitorCallback {
     ...
     */
    void callbackUpstream(Command command, byte[] key, long size, long threshold);
     ...
     * @param threshold config of big key threshold
     */
    void callbackDownstream(Command command, Reply reply, byte[] key, long size, long threshold);
}
