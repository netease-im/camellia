...
public class InfoUtils {
    ...
    private static final String VERSION = "v1.0.28";
    ...
    public static BulkReply getInfoReply() {
        ...
        builder.append("connect_clients:").append(ChannelMonitor.getChannelMap().size()).append("\n");
        builder.append("\n");
        ...
        for (Map.Entry<String, AsyncCamelliaRedisTemplate> entry : templateMap.entrySet()) {
            ...
            String routeConf = ReadableResourceTableUtil.readableResourceTable(template.getResourceTable());
        ...
        for (Map.Entry<RedisClientAddr, ConcurrentHashMap<String, RedisClient>> entry : redisClientMap.entrySet()) {
            builder.append("upstream_redis_nums").append("[").append(entry.getKey().getUrl()).append("]").append(":").append(entry.getValue().size()).append("\n");
        }
        builder.append("\n");
